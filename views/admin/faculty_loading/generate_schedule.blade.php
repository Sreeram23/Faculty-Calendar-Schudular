...
?>
<button class="no-print" onclick="myFunction()" style="font-family: 'Poppins', sans-serif;">Print Schedule</button>
...
<div class="a" style="font-family: 'Poppins', sans-serif;">
    <b>Sample University</b>
     </div>
<div class="b" style="font-family: 'Poppins', sans-serif;">
<!--         <b> {{$faculty->lastname}}, {{$faculty->name}} </b>-->
    Class/Faculty Room Schedule
    </div>
<div class="c" style="font-family: 'Poppins', sans-serif;">
<!--         {{$info->department}} -->
Second SEMESTER SY <b>2018-2019</b>
</div>
    
<div class="form form-group" align="center" style="font-family: 'Poppins', sans-serif;">
