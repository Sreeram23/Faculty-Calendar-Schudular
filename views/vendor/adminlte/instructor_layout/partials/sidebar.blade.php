        ...
        @if (! Auth::guest())
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="http://127.0.0.1:8000/images/avatar5.png" class="img-circle" alt="User Imge"  />
...
<!--        <form action="#" method="get" class="sidebar-form">
       ...
       <!-- <ul class="sidebar-menu">
            ...
            <li class=""><a href="{{ url('/instructor/faculty_loading') }}"><i class='fa fa-calendar-check-o '></i> <span>Faculty Calendar</span></a></li>
