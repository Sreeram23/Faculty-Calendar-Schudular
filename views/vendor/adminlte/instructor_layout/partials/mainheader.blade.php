...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>FACULTY</b></span>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="http://127.0.0.1:8000/images/avatar5.png" class="user-image" alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="http://127.0.0.1:8000/images/avatar5.png" class="img-circle" alt="User Image" />
                                <p>
                                    {{ Auth::user()->name }}
