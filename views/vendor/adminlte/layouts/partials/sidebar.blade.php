...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        @if (! Auth::guest())
            <div class="user-panel"  style="font-family: 'Poppins', sans-serif;">
       ...
       <!-- <ul class="sidebar-menu">
        ...
        <li  style="font-family: 'Poppins', sans-serif;"><a href="/admin/faculty_loading"><i class='fa  fa-list'></i> <span>Faculty Loading</span></a></li>
        
        <li class="treeview" style="font-family: 'Poppins', sans-serif;">
            <a href="#"><i class="fa fa-gears"></i> <span>Maintenance </span>
        ...
        <li class="treeview"  style="font-family: 'Poppins', sans-serif;">
            <a href="#"><i class="fa fa-folder"></i> <span>Curriculum </span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
        ...
        <?php $notifications = \App\LoadNotification::where('is_trash',0)->get();?>
                <li class=""  style="font-family: 'Poppins', sans-serif;"><a href="{{ url('/admin/notification') }}"><i class='fa fa-bell-o '></i> <span>Notifications</span> @if(count($notifications)>0)<label class="label label-warning text-warning"><i class="">{{$notifications->count()}}</i></label> @endif </a></li>
                <li class=""  style="font-family: 'Poppins', sans-serif;"><a href="{{ url('/account/change_password') }}"><i class='fa fa-lock '></i> <span>Change Password</span></a></li>
