...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span style="font-family: 'Poppins', sans-serif;" class="logo-mini"><b>AMRITA ADMIN</b></span>
        <!-- logo for regular state and mobile devices -->
        <span style="font-family: 'Poppins', sans-serif;" class="logo-lg"><b>AMRITA ADMIN</b></span>
    </a>
                ...
                <!-- Notifications Menu -->
                  <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="footer" style="font-family: 'Poppins', sans-serif;"><a href="{{url('/admin/notification')}}">View all</a></li>
                    </ul>
                  </li>
                <!-- Tasks Menu -->
...
<!--                                <div class="pull-left">
                                ...
                                <div class="pull-right">-->
                                    ...
                                    <form id="logout-form" action="{{ url('/logout') }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                        <input style="font-family: 'Poppins', sans-serif;" type="submit" value="logout" style="display: none;">
                                    </form>
